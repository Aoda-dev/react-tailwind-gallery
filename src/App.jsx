...
function App() {
  ...
  useEffect(() => {
    setIsLoading(true)
    fetch(`https://pixabay.com/api/?key=${import.meta.env.VITE_PIXABAY_KEY}&q=${term}&image_type=photo&pretty=true&safesearch=true`)
      .then((res) => res.json())
      .then((data) => {
        setImages(data.hits)
        setIsLoading(false)
  ...
  return (
    <div className='container mx-auto'>
      <ImageSearch setLoading={setIsLoading} searchText={(text) => setTerm(text)} />
